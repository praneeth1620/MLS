...
import { LayoutConfig, InteractionConfig, ContentConfig, DisplayConfig, MediaConfig, AnimationConfig, StyleConfig, AccessibilityConfig, I18nConfig, DarkModeConfig } from './TimelineConfig';
/**
 * Timeline display modes
 */
export type TimelineMode = 'horizontal' | 'vertical' | 'alternating' | 'horizontal-all';
/**
...
//# sourceMappingURL=TimelinePropsV2.d.ts.map